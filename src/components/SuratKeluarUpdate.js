...
class SuratKeluarUpdate extends Component {
    ...
    async componentDidMount(){
        let url = '/suratkeluar/' + this.props.location.pathname.slice(23)
    ...
    handlePost = (e) => {
        ...
        axios.put(`/suratkeluar/update/${this.state.id}`, data)
            .then(() => window.location.href = '/Howry/disposisi' )
    }
...
export default SuratKeluarUpdate